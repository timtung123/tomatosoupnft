...
function App() {
  ...
  const [feedback, setFeedback] = useState(`1 Freemint than 0.003 per`);
...
“Meanwhile, crops are failing, and people are dying in supercharged monsoons, massive wildfires and endless droughts caused by climate breakdown,” Plummer added.            </s.TextDescription>
        ...
        <StyledPFP style={{
            ...
            <iframe width="1120" height="730" src="https://www.youtube.com/embed/LTdquzu-BXg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </s.Container>
          <s.SpacerLarge />
        <s.Container jc={"center"} ai={"center"} style={{ width: "70%" }}>
          <s.TextDescription
